...
from C_07_Game_History import game_history
...
while comp_score < game_goal and user_score < game_goal:
    ...
    # if the computer has fewer, switch the computer to 'player 1
    else:
...
if user_score > comp_score:
   make_statement("The user won","👍")  # replace this with the generator call
else:
